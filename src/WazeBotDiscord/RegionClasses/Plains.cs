...
{
    public class PlainsChannels
    {
        public const ulong StateManagers = 0;
        public const ulong LargeAreaManagers = 0;
        public const ulong AreaManagers = 0;
        public const ulong Iowa = 0;
        public const ulong Kansas = 0;
        public const ulong Minnesota = 0;
        public const ulong Missouri = 0;
        public const ulong Nebraska = 0;
        public const ulong NorthDakota = 0;
        public const ulong SouthDakota = 0;
    }

    public class PlainsRoles
    {
        public const ulong Plains = 0;
